create table if not exists public.usage_records (
  ...
  customer_charge_cents bigint not null default 0 check (customer_charge_cents >= 0),
  provider_cost_reference text,
...
grant execute on function public.record_usage_charge(uuid, uuid, uuid, text, integer, integer, integer, bigint, text, text) to service_role;
