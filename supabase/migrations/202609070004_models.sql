create table if not exists public.models (
  ...
  customer_input_price_per_million numeric(12,4) not null default 0,
  customer_output_price_per_million numeric(12,4) not null default 0,
  customer_cached_input_price_per_million numeric(12,4) default 0,
...
insert into public.models (
  ...
  customer_input_price_per_million,
  customer_output_price_per_million,
...
set
  ...
  customer_input_price_per_million = excluded.customer_input_price_per_million,
  customer_output_price_per_million = excluded.customer_output_price_per_million,
  customer_cached_input_price_per_million = excluded.customer_cached_input_price_per_million,
