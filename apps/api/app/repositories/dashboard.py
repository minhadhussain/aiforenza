...
async def fetch_usage_records(user_id: str, limit: int = 50) -> list[dict]:
    return await rest_select(
        ...
        params={
            ...
            "select": "id,request_id,input_tokens,output_tokens,cached_input_tokens,total_tokens,reference_charge_cents,customer_charge_cents,customer_savings_cents,provider_cost_cents,status,created_at,model:models(slug,display_name)",
